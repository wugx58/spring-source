...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	protected void registerListeners() {
		// Register statically specified listeners first.   /*xxx: 首先注册静态指定的监听器*/
		for (ApplicationListener<?> listener : getApplicationListeners()) {
			getApplicationEventMulticaster().addApplicationListener(listener);
		}

		// Do not initialize FactoryBeans here: We need to leave all regular beans
		// uninitialized to let post-processors apply to them!  /*xxx: 注册从bean容器中指定的监听器*/
		...
		Set<ApplicationEvent> earlyEventsToProcess = this.earlyApplicationEvents; /*xxx: 广播发布所有预先指定的应用事件*/
